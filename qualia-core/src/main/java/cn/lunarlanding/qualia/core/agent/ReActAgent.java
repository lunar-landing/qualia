...
import cn.lunarlanding.qualia.core.tool.annotation.AsFunctionTool;
...
import cn.lunarlanding.qualia.core.tool.FunctionToolScanner;
import cn.lunarlanding.qualia.core.tool.McpToolAdapter;
import cn.lunarlanding.qualia.core.tool.AgentToolAdapter;
import cn.lunarlanding.qualia.core.knowledge.KnowledgeBase;
import cn.lunarlanding.qualia.core.model.rerank.RerankModel;
import cn.lunarlanding.qualia.core.tool.KnowbaseToolAdapter;
import cn.lunarlanding.qualia.core.memory.Memory;
import cn.lunarlanding.qualia.core.memory.impl.MemMemory;
import cn.lunarlanding.qualia.core.agent.context.ContextManager;
import cn.lunarlanding.qualia.core.constant.Constant;
import cn.lunarlanding.qualia.core.skill.Skill;
import cn.lunarlanding.qualia.core.tool.ToolCall;
import cn.lunarlanding.qualia.core.tool.impl.skill.SkillSelector;
import cn.lunarlanding.qualia.core.tool.impl.skill.SkillLoader;
import cn.lunarlanding.qualia.core.tool.impl.skill.SkillReferenceReader;
import cn.lunarlanding.qualia.core.tool.impl.skill.SkillScriptRunner;
...
public class ReActAgent implements Agent {
    ...
    private void runIteration(FluxSink<AgentResponse> emitter, List<ChatMessage> messages,
        ...
        if (current >= maxIterations) {
            ...
            // 保存到记忆
            if (contextManager.getMemory() != null) {
                contextManager.getMemory().addAssistantMessage(sessionId, finalResponse, new ArrayList<>(allSteps), null, null, null);
            }
